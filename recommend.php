...
//接收微信号来查询到底是谁的信息
	$get_class1 = $_GET['item_class1'] ;//推荐类别1
	$get_class2 = $_GET['item_class2'] ;//推荐类别2
	$get_class3 = $_GET['item_class3'] ;//推荐类别3
	$get_class4 = $_GET['item_class4'] ;//推荐类别4
	$get_class5 = $_GET['item_class5'] ;//推荐类别5
...
//先连接数据库db1
    ...
    //获取内容
    $sql = "select * from unreceive where item_class='{$get_class1}' or item_class='{$get_class2}' or item_class='{$get_class3}' or item_class='{$get_class4}' or item_class='{$get_class5}' " ; 
    ...
    class Pinformation{
		...
		public $time_start ; //期待发货时间
		public $time_end ; //期待到达时间
