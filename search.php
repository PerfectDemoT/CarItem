...
//接收微信号来查询到底是谁的信息
	$get_search = $_GET['search_name'] ;//微信号
...
//先连接数据库db1
    ...
    //获取内容
    $sql = "select * from unreceive where user_name='{$get_search}' or item_name='{$get_search}' or item_class='{$get_search}' or send_address='{$get_search}' or get_address='{$get_search}' or convey_class='{$get_search}' or weight='{$get_search}' or price='{$get_search}' " ;
